...
// Imported from <model-viewer> project:
// https://github.com/google/model-viewer

// Amended with support for XR Light Estimation:
...
declare interface XRFrame {
    ...
    getLightEstimate(lightProbe: XRLightProbe);
}
...
declare interface XRSession extends EventTarget {
    ...
    requestLightProbe(options?: XRRequestLightProbeOptions);
    end(): Promise<void>;
...
// Custom extension: Lighting estimation support
...
declare interface XRLightProbe extends EventTarget {
    onrefletionchange: Function<Event>;
